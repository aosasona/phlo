...
class Config
{
    public static function load(string $path, bool $must_exist = false): bool
    {
        try {
            $file_env = self::loadFromFile($path, $must_exist);
    ...
    private static function loadFromFile(string $path = ".env", bool $must_exist = false): array
    {
